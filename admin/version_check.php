  ...
  <div class="col-sm-12">
        <div class="card mb-3">
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>   
      <tr>
        <td class="smallText"><?php echo TITLE_INSTALLED_VERSION . ' <strong>FieldMitr Online Merchant v' . $current_version . '</strong>'; ?></td>
      </tr>
      <tr>
...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                <td class="dataTableContent"><?php echo '<a href="' . $version[2] . '" target="_blank">FieldMitr Online Merchant v' . $version[0] . '</a>'; ?></td>
