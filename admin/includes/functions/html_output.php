...
// Output a form input field
  function tep_draw_input_field($name, $value = '', $parameters = '', $required = false, $type = 'text', $reinsert_value = true) {
    $field = '<input class="form-control form-control-sm" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
  ...
  function tep_draw_sm_input_field($name, $value = '', $parameters = '', $required = false, $type = 'text', $reinsert_value = true) {
    $field = '<input class="form-control form-control-sm" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
...
// Output a selection field - alias function for tep_draw_checkbox_field() and tep_draw_radio_field()
  function tep_draw_selection_field($name, $type, $value = '', $checked = false, $compare = '') {
    $selection = '<div class="form-check"><input class="form-check-input" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
  ...
  ////
// Output a selection field - alias function for tep_draw_checkbox_field() and tep_draw_radio_field()
function tep_draw_std_selection_field($name, $type, $value = '', $checked = false, $compare = '') {
  $selection = '<input class="form-check-input" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
  ...
  function tep_draw_bs_selection_field($name, $type, $value = '', $checked = false, $compare = '', $label = '', $class = '') {
    $selection = '<div class="form-check ' . $class . '"><input class="form-check-input" type="' . tep_output_string($type) . '" name="' . tep_output_string($name) . '"';
    ...
    $selection .= ' /><label class="form-check-label">' . $label . '</label></div>';
...
// Output a form checkbox field
  ...
  function tep_draw_bs_checkbox_field($name, $value = '', $checked = false, $compare = '', $label, $class) {
    return tep_draw_bs_selection_field($name, 'checkbox', $value, $checked, $compare, $label, $class);
  }
////
...
////
// Output a bootstrap form radio field
function tep_draw_bs_radio_field($name, $value = '', $checked = false, $compare = '', $label, $class) {
  return tep_draw_bs_selection_field($name, 'radio', $value, $checked, $compare, $label, $class);
}
// Output a std form radio field
function tep_draw_std_radio_field($name, $value = '', $checked = false, $compare = '') {
  return tep_draw_std_selection_field($name, 'radio', $value, $checked, $compare);
}
////
...
// Output a form textarea field
// The $wrap parameter is no longer used in the core xhtml template
function tep_draw_editor_textarea_field($name, $wrap, $width, $height, $text = '', $parameters = '', $reinsert_value = true) {
  $field = '<div class="form-group"><textarea class="form-control editor" name="' . tep_output_string($name) . '" cols="' . tep_output_string($width) . '" rows="' . tep_output_string($height) . '"';
...
// Output a form pull down menu
  function tep_draw_pull_down_menu($name, $values, $default = '', $parameters = '', $required = false) {
    $field = '<select class="form-control form-control-sm" name="' . tep_output_string($name) . '"';
...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $class = null) {
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
      $button .= '<a class="btn btn-sm btn-' . $class . '" href="' . $link . '"';

      if ( isset($params['newwindow']) ) {
        $button .= ' target="_blank"';
      }
    } else {
      $button .= '<button class="btn btn-sm btn-' . $class . '" type="' . tep_output_string($params['type']) . '"';
    }
