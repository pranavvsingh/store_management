...
*/
  ...
  class d_partner_news {
      ...
      if (is_array($result) && !empty($result)) {
        ...
        <div class="card mb-3">
                  <div class="card-header">
                    <h6><i class="fa fa-newspaper-o"></i> ' . MODULE_ADMIN_DASHBOARD_PARTNER_NEWS_TITLE . '
                  ...
                  <thead>
                    <tr>
                      <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_PARTNER_NEWS_TITLE . '</th>
                    </tr>
                  </thead>
                  <tbody>';       
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Partner News Module', 'MODULE_ADMIN_DASHBOARD_PARTNER_NEWS_STATUS', 'True', 'Do you want to show the latest FieldMitr Partner News on the dashboard?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
