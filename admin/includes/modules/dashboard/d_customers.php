    ...
    function getOutput() {
      ...
      <div class="card mb-3">
                <div class="card-header">
                  <h6><i class="fa fa-user"></i> ' . MODULE_ADMIN_DASHBOARD_CUSTOMERS_TITLE . '
                ...
                <thead>
                  <tr>
                    <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_CUSTOMERS_TITLE . '</th>
                    <th scope="col">' . MODULE_ADMIN_DASHBOARD_CUSTOMERS_DATE . '</th>
      ...
      while ($customers = tep_db_fetch_array($customers_query)) {
        $output .= '  <tr class="dataTableRow" onmouseover="rowOverEffect(this);" onmouseout="rowOutEffect(this);">' .
                   ...
                   '    <td class="dataTableContent">' . tep_date_short($customers['customers_info_date_account_created']) . '</td>' .
                   '  </tr>';
      }
