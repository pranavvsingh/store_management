    ...
    function getOutput() {
      ...
      <div class="card mb-3">
                <div class="card-header">
                  <h6><i class="fa fa-credit-card"></i> ' . MODULE_ADMIN_DASHBOARD_ORDERS_TITLE . '
                ...
                <thead>
                  <tr>
                    <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_ORDERS_TITLE . '</th>
                    <th scope="col">' . MODULE_ADMIN_DASHBOARD_ORDERS_TOTAL . '</th>
                    <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_ORDERS_DATE . '</th>
                    <th scope="col">' . MODULE_ADMIN_DASHBOARD_ORDERS_ORDER_STATUS . '</th>                    
                  </tr>
                </thead>
                <tbody>';
