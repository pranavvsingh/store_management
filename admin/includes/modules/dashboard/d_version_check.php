    ...
    function getOutput() {
      ...
      <div class="card mb-3">
                <div class="card-header">
                  <h6><i class="fa fa-user"></i> ' . MODULE_ADMIN_DASHBOARD_VERSION_CHECK_TITLE . '
                ...
                <thead>
                  <tr>
                    <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_VERSION_CHECK_TITLE . '</th>
                    <th scope="col">' . MODULE_ADMIN_DASHBOARD_VERSION_CHECK_DATE . '</th>
