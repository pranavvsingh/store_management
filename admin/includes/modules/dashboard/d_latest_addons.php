...
*/
  ...
  class d_latest_addons {
    ...
    function getOutput() {
      ...
      <div class="card mb-3">
                <div class="card-header">
                  <h6><i class="fa fa-code-fork"></i> ' . MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_TITLE . '</h6>
                </div>
                <div class="card-body"><div class="table-responsive">
                <table class="table table-hover table-bordered table-sm">
                <thead>
                  <tr>
                    <th scope="col"> ' . MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_TITLE . '</th>
                    <th scope="col">' . MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_DATE . '</th>
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Latest Add-Ons Module', 'MODULE_ADMIN_DASHBOARD_LATEST_ADDONS_STATUS', 'True', 'Do you want to show the latest FieldMitr Add-Ons on the dashboard?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
