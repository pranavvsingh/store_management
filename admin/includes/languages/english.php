...
define('BOX_CATALOG_MASSUPLOAD', 'MassUpload');
...
define('FILENAME_EXCEL', 'excelData.xls');
...
define('PREVNEXT_BUTTON_PREV', '<i class="fa fa-chevron-left" aria-hidden="true"></i>');
define('PREVNEXT_BUTTON_NEXT', '<i class="fa fa-chevron-right" aria-hidden="true"></i>');
