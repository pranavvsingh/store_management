...
define('TEXT_INFO_HEADING_COPY_TO', 'Copy');
...
define('TEXT_PRODUCTS_IMAGE_DRAG', 'Drag and drop large images up/down to rearrange order:');
...
const TEXT_PRODUCTS_GTIN = 'Products <abbr title="GTIN must be stored as 14 Digits. Any GTIN smaller than this will be zero-padded per GTIN Specifications.">GTIN</abbr>: <small>1 of UPC, EAN, ISBN etc</small>';
const TEXT_PRODUCTS_SEO_DESCRIPTION = 'Product Meta Description for SEO:<br><small>Add a &lt;description&gt; Meta Element. HTML is not allowed.</small>';
const TEXT_PRODUCTS_SEO_KEYWORDS = 'Product Meta Keywords for SEO:<br><small>Add a <abbr title="Must be comma separated. HTML is not allowed.">&lt;keyword&gt; Meta Element</abbr> or Search Engine. </small>';
const TEXT_PRODUCTS_SEO_TITLE = 'Products Title <abbr title="Replaces the product name in the &lt;title&gt; Meta Element and optionally in the Breadcrumb Trail.">SEO</abbr>:  <small>(Leave blank to default to name)</small>';
