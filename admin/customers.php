...
<?php
  ...
  switch ($action) {
    case 'confirm':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br />' . tep_draw_button(IMAGE_DELETE, 'trash', null, 'primary', null, 'secondary') . ' ' . tep_draw_button(IMAGE_CANCEL, 'close', tep_href_link('customers.php', tep_get_all_get_params(array('cID', 'action')) . 'cID=' . $cInfo->customers_id)));
      break;
    default:
...
<script type="text/javascript">
$('input[name="customers_dob"]').datepicker({
  dateFormat: 'mm/dd/yy'
});
</script>
<script>
  $(document).ready(function () {
    ...
    $('input[name="customers_dob"]').daterangepicker({
