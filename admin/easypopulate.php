...
//		header('Content-type: application/vnd.ms-excel; charset="utf-8"');
        ...
        fclose($fp);
		$ep_message_stack = "You can get your file in the Tools/File Manager here: " . EP_TEMP_DIRECTORY . "EP" . $EXPORT_TIME . ((EP_EXCEL_SAFE_OUTPUT == true)?".csv":".txt");
        //die();
    }
}
...
?>
      ...
      <table width="<?php if (EP_SHOW_EP_SETTINGS == true) { echo '95'; } else { echo '75'; } ?>%" cellpadding="5" cellspacing="0" style="border-collapse:collapse;">
        <tr>
          <td width="75%" style="border-style:solid; border-width:thin; border-color:#CCCCCC;"><span style="font-size:10px;background-color:#FFFFCC; width:100%;">&nbsp; &nbsp;Please <a href="backup.php<?php if (defined('SID') && tep_not_null(SID)) { echo '?'.tep_session_name().'='.tep_session_id(); } ?>" style="font-size:10px;background-color:#FFFFCC;text-decoration:underline;">backup your database</a> before performing any Easy Populate operations!&nbsp; &nbsp;</span>
		  <?php
		  // Quick Backup Button
		   if (EP_QUICK_BACKUP == true){
		   ?>
		   <form name="quick_backup" action="backup.php?action=backupnow<?php if (defined('SID') && tep_not_null(SID)) { echo '&'.tep_session_name().'='.tep_session_id(); } ?>" method="post" id="quick_backup">
				<input type="submit" name="quick_backup_button" value="Quick Backup"  style="padding: 0px" /></form>
		   <?php
			}
			?>
			<br />
...
<?php } ?>
        ...
        <p>
          ...
          <table border="0" cellpadding="0" cellspacing="0"><tr><td class="smallText">
             ...
             Unlimited Images: <?php echo (EP_UNLIMITED_IMAGES?'true':'false'); ?><br />
			 ...
			 Quick Backup Enabled: <?php echo (EP_QUICK_BACKUP?'true':'false'); ?><br />
             <br />
