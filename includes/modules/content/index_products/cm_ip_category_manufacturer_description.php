...
*/
  ...
  class cm_ip_category_manufacturer_description {
    ...
    function __construct() {
      ...
      $this->title = MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_TITLE;
      $this->description = MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_DESCRIPTION;
      $this->description .= '<div class="secWarning">' . MODULE_CONTENT_BOOTSTRAP_ROW_DESCRIPTION . '</div>';

      if ( defined('MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_STATUS') ) {
        $this->sort_order = MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_SORT_ORDER;
        $this->enabled = (MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_STATUS == 'True');
      }      
    }
    ...
    function check() {
      return defined('MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_STATUS');
    }
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_SORT_ORDER', '100', 'Sort order of display. Lowest is displayed first.', '6', '2', now())");
    }
    ...
    function keys() {
      return array('MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_STATUS', 'MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_CONTENT_WIDTH', 'MODULE_CONTENT_IP_CATEGORY_DESCRIPTION_SORT_ORDER');
    }    
  }
