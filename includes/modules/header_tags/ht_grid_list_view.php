...
EOD;
  ...
  function ht_grid_list_view_edit_pages($values, $key) {
    ...
    foreach ($files_array as $file) {
      $output .= tep_draw_bs_checkbox_field('ht_grid_list_view_file[]', $file, in_array($file, $values_array), '',tep_output_string($file),'');
    }
    ...
    $output .= '<script>
                function htrn_update_cfg_value() {
                  ...
                  if ($(\'.form-check input[name="ht_grid_list_view_file[]"]\').length > 0) {
                    $(\'.form-check input[name="ht_grid_list_view_file[]"]:checked\').each(function() {
                ...
                $(function() {
                  ...
                  if ($(\'.form-check input[name="ht_grid_list_view_file[]"]\').length > 0) {
                    $(\'.form-check input[name="ht_grid_list_view_file[]"]\').change(function() {
                      htrn_update_cfg_value();
                    });
                  }
                });
