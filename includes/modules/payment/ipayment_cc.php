...
// class constructor
    function __construct() {
      ...
      if ( defined('MODULE_PAYMENT_IPAYMENT_CC_STATUS') ) {
...
// class methods
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('silent', '1') .
                               ...
                               tep_draw_hidden_field('client_name', 'FieldMitr') .
...
// verify ret_param_checksum
        if ($_GET['ret_param_checksum'] != md5(MODULE_PAYMENT_IPAYMENT_CC_USER_ID . ($this->format_raw($order->info['total']) * 100) . $currency . $_GET['ret_authcode'] . $_GET['ret_booknr'] . MODULE_PAYMENT_IPAYMENT_CC_SECRET_HASH_PASSWORD)) {
          $pass = false;
        }
