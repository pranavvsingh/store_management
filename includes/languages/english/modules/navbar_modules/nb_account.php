...
*/
  ...
  define('MODULE_NAVBAR_ACCOUNT_LOGIN', '<i class="fas fa-sign-in-alt"></i> Log In');
  define('MODULE_NAVBAR_ACCOUNT_LOGOFF', '<i class="fas fa-sign-out-alt"></i> Log Off');
  ...
  define('MODULE_NAVBAR_ACCOUNT_REGISTER', '<i class="fas fa-pencil-alt"></i> Register');
