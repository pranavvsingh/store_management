...
define('FREE_SHIPPING_TITLE', 'Store Pickup');
...
define('ENTRY_TELEPHONE_NUMBER', 'Mobile Number (Whatsapp Number)');
define('ENTRY_TELEPHONE_NUMBER_ERROR', 'Your Mobile Number must contain a minimum of ' . ENTRY_TELEPHONE_MIN_LENGTH . ' characters.');
