  ...
  <div style="float: left; width: 50%;">
    <div style="padding: 2px;">
      ...
      <div class="pp-panel pp-panel-info">
        <?php echo $OSCOM_PayPal->getDef('online_documentation_body', array('button_online_documentation' => $OSCOM_PayPal->drawButton($OSCOM_PayPal->getDef('button_online_documentation'), 'http://library.FieldMitr.com/Package&paypal&oscom23', 'info', 'target="_blank"'))); ?>
      </div>
    </div>
  </div>
  ...
  <div style="float: left; width: 50%;">
    <div style="padding: 2px;">
      ...
      <div class="pp-panel pp-panel-warning">
        <?php echo $OSCOM_PayPal->getDef('online_forum_body', array('button_online_forum' => $OSCOM_PayPal->drawButton($OSCOM_PayPal->getDef('button_online_forum'), 'http://forums.FieldMitr.com/forum/54-paypal/', 'warning', 'target="_blank"'))); ?>
      </div>
    </div>
  </div>
</div>
