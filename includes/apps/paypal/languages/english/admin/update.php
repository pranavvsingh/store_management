...
button_visit_app_page = Visit App at FieldMitr

retrieving_update_list = Retrieving update availability list &hellip;
manual_update_available = v:version is available as an update! This can be downloaded and applied manually from the FieldMitr Apps site.
