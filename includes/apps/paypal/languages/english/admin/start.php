...
onboarding_intro_body = <p>Start selling and earning faster by allowing FieldMitr to automatically and securely configure your online store with your PayPal API credentials.</p>
...
alert_onboarding_connection_error = Could not connect to the FieldMitr website to initiate the start account procedure. Please try again in a short while.
...
alert_onboarding_retrieve_connection_error = Could not connect to the FieldMitr website to retrieve the PayPal account credentials. Please try again in a short while.
